    ...
    public SecurityFilterChain filterChain(final @NotNull HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/login", "/register", "/register/email", "/pwd/email", "/pwd/change", "/token/refresh", "/main", "/council", "/news", "/info", "/mou", "/member").permitAll()
                        .requestMatchers("/council/admin", "/news/admin", "/info/admin", "/mou/admin", "/member/admin").hasAnyRole("ADMIN", "SUPER")
