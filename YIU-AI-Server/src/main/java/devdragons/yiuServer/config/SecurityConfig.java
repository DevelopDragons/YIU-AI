    ...
    public SecurityFilterChain filterChain(final @NotNull HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/login", "/register", "/register/email", "/pwd/email", "/pwd/change", "/token/refresh", "/main", "/council", "/news", "/info", "/mou", "/member", "/graduateSchool", "/microdegree", "/curriculum", "/files/*", "/microdegree", "/microdegreeSubject", "/greeting", "/graduation").permitAll()
