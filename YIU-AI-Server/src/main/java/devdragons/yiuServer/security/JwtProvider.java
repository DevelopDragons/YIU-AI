...
import devdragons.yiuServer.service.JpaUserDetailsService;
...
public class JwtProvider {
    ...
    public String createToken(User user) {
        ...
        if (user.getRole() == UserRoleCategory.SUPER) {
            jwtBuilder.claim("role", "SUPER");
        } else if (user.getRole() == UserRoleCategory.SUPER) {
            jwtBuilder.claim("role", "ADMIN");
        } else {
            jwtBuilder.claim("role", "STUDENT");
        }
